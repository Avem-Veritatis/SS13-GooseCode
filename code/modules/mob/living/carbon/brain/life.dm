/mob/living/carbon/brain/Life()
	...
	var/datum/gas_mixture2/environment // Added to prevent null location errors
	if(loc)
...
/mob/living/carbon/brain/
	...
	proc/handle_environment(datum/gas_mixture2/environment)
		if(!environment)
			return
		var/environment_heat_capacity = 1 //Why... Why is this system... To hell with it this is just going to be "1".
