/turf/simulated/wall
	...
	//var/walltype = "iron"
	//icon_state = "iron0"
	icon_state = "polar0" //New wall sprites... Again!
	var/walltype = "polar"
...
/turf/simulated/wall/attackby(obj/item/weapon/W as obj, mob/user as mob)
	...
	/* //Ship builder is now deprecated. I will leave this scrap of code for later use just in case though. For now.
	if(istype(W, /obj/item/device/shipbuilder))
		var/obj/item/device/shipbuilder/S = W
		if(S.turfs.len > 0)
