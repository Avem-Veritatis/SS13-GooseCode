...
/datum/admins/proc/access_news_network() //MARKER
	...
	switch(admincaster_screen)
		if(0)
			...
			dat+="<BR><A href='?src=\ref[src];ac_menu_censor_channel=1'>Mark Feed Channel with Imperial D-Notice (disables and locks the channel.</A>"
...
/datum/admins/proc/Secrets()
	...
	var/dat = "<B>Make sure you have at least one goose before running an event.</B><HR>"
