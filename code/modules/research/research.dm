...
datum/tech/bluespace
	name = "'Sub-Space' Research"
	desc = "Research into the 'subspace'"
	id = "bluespace"
...
datum/tech/syndicate
	...
	desc = "The study of technologies that violate Mechanicus regulations."
	id = "syndicate"

/*
datum/tech/arcane //Oh? What is this. Could be interesting for a future corruption path... -Drake
