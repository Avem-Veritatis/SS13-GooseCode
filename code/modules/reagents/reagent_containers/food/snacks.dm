...
/obj/item/weapon/reagent_containers/food/snacks/ccake
	...
	New()
		..()
		src << "<font color='red'> You feel a sudden hatred for the AI.</font>"
		reagents.add_reagent("nutriment", 1)
		reagents.add_reagent("sugar", 3)
		bitesize = 2
...
/obj/item/weapon/reagent_containers/food/snacks/chips/eucalyptus
	name = "eucalyptus chips"
	desc = "KoalaCo eucalyptus chips. Probably made by a koala or something..."
	icon_state = "echips"
	trash = /obj/item/trash/chips
	filling_color = "#FEFF92"
	New()
