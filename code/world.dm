...
/world/New()
	...
	plmaster.layer = TURF_LAYER+0.1
	plmaster.mouse_opacity = 0

	slmaster = new /obj/effect/overlay()
	slmaster.icon = 'icons/effects/tile_effects.dmi'
	slmaster.icon_state = "sleepgas"
	slmaster.layer = TURF_LAYER+0.1
	slmaster.mouse_opacity = 0
	slmaster.alpha = 100

	slmaster2 = new /obj/effect/overlay()
	slmaster2.icon = 'icons/effects/tile_effects.dmi'
	slmaster2.icon_state = "sleepgas"
	slmaster2.layer = TURF_LAYER+0.1
	slmaster2.mouse_opacity = 0
	slmaster2.alpha = 50

	slmaster3 = new /obj/effect/overlay()
	slmaster3.icon = 'icons/effects/tile_effects.dmi'
	slmaster3.icon_state = "sleepgas"
	slmaster3.layer = TURF_LAYER+0.1
	slmaster3.mouse_opacity = 0
	slmaster3.alpha = 25
...
#endif
	spawn(0)
		world << sound(pick('sound/misc/roundend.ogg','sound/misc/roundend2.ogg'))
