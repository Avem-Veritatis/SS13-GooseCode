...
/obj/effect/proc_holder/changeling/humanform/sting_action(var/mob/living/carbon/user)
	...
	var/chosen_name = input("Select the target identity: ", "Target identity", null) as null|anything in names
	if(!chosen_name)
		return
	...
	user << "<span class='notice'>You transform your appearance.</span>"
	user.dna = chosen_dna
