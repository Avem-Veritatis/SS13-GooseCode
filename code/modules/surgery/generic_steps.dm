...
/datum/surgery_step/saw
	implements = list(/obj/item/weapon/circular_saw = 100, /obj/item/weapon/chainsword = 90, /obj/item/weapon/complexsword/arm_blade = 75, /obj/item/weapon/hatchet = 35, /obj/item/weapon/butch = 25)
	time = 64
