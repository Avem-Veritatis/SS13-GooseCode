...
/datum/table_recipe/shield
	name = "Makeshift Shield"
	result_path = /obj/item/weapon/shield/riot/makeshift
	reqs = list(/obj/item/weapon/handcuffs/cable = 2,
				/obj/item/stack/rods = 4,
				/obj/item/stack/sheet/metal = 6,
				)
	time = 80

/datum/table_recipe/reciever
	name = "Reciever"
	result_path = /obj/item/weapon/gun_part/reciever
...
/datum/table_recipe/shotgunshell
	name = "Makeshift Shotgun Shell"
	result_path = /obj/item/ammo_casing/shotgun/makeshift
...
/datum/table_recipe/shotgunslug
	name = "Makeshift Shotgun Slug"
	result_path = /obj/item/ammo_casing/shotgun/makeshift/slug
	reqs = list(/datum/reagent/fuel = 10,
				/datum/reagent/sulfur = 10,
...
/datum/table_recipe/shotgunslug
	name = "Makeshift Promethium Slug"
	result_path = /obj/item/ammo_casing/shotgun/makeshift/promethium
	reqs = list(/datum/reagent/fuel = 10,
				/datum/reagent/sulfur = 10,
				/datum/reagent/burn = 10,
				/obj/item/stack/sheet/metal = 3,
				/obj/item/weapon/paper = 1
				)
	time = 80

/datum/table_recipe/fragslug
	name = "Makeshift Fragmentation Shell"
	result_path = /obj/item/ammo_casing/shotgun/makeshift/overcharge
	reqs = list(/datum/reagent/fuel = 10,
				/obj/item/weapon/grenade/imperial = 1,
...
/obj/structure/table/glasstable
	name = "glass table"
	desc = "Do not apply hammers to this. Rumour says it breaks easily."
...
/obj/structure/table/imperialwoodentable
	name = "wooden table"
...
/obj/structure/table/altar
	...
	desc = "A stone table."
	icon_state = "altar"
	parts = /obj/item/weapon/ore/glass

/obj/structure/table/ksons
	name = "table"
	desc = "A golden table."
	icon_state = "ksonsrack"
	parts = /obj/item/stack/sheet/mineral/gold
...
/obj/structure/rack/dk
	name = "Tactical Map"
	desc = "It's a map of a surface location."
	icon = 'icons/obj/structures.dmi'
	icon_state = "map5"
	density = 1
	anchored = 1.0
