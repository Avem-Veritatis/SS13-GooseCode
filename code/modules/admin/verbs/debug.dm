...
// DEATH SQUADS
		...
		if("SoseFireTeam")
			...
			M.equip_to_slot_or_del(new /obj/item/clothing/under/rank/security/fire(M), slot_w_uniform)
			M.equip_to_slot_or_del(new /obj/item/clothing/suit/armor/swat(M), slot_wear_suit)
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/imperialboots/reinforced(M), slot_shoes)
			M.equip_to_slot_or_del(new /obj/item/clothing/gloves/combat(M), slot_gloves)
			M.equip_to_slot_or_del(new /obj/item/clothing/glasses/sunglasses/big(M), slot_glasses)
			M.equip_to_slot_or_del(new /obj/item/clothing/mask/gas/swat(M), slot_wear_mask)
			M.equip_to_slot_or_del(new /obj/item/device/flashlight/lantern(M), slot_l_store)
			M.equip_to_slot_or_del(new /obj/item/clothing/head/valhalla(M), slot_head)
			M.equip_to_slot_or_del(new /obj/item/weapon/gun/grenadelauncher(M), slot_belt)
			M.equip_to_slot_or_del(new /obj/item/weapon/grenade/imperial(M), slot_r_store)
			M.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack(M), slot_back)
			M.equip_to_slot_or_del(new /obj/item/weapon/tank/emergency_oxygen/double/DK(M), slot_s_store)
			M.equip_to_slot_or_del(new /obj/item/weapon/gun/projectile/automatic/deagle/m1911(M), slot_in_backpack)
			M.equip_to_slot_or_del(new /obj/item/weapon/grenade/chem_grenade/incendiary(M), slot_in_backpack)
			M.equip_to_slot_or_del(new /obj/item/weapon/grenade/chem_grenade/incendiary(M), slot_in_backpack)
			M.equip_to_slot_or_del(new /obj/item/weapon/grenade/chem_grenade/incendiary(M), slot_in_backpack)
			M.equip_to_slot_or_del(new /obj/item/weapon/grenade/chem_grenade/incendiary(M), slot_in_backpack)
			M.equip_to_slot_or_del(new /obj/item/weapon/storage/firstaid/advanced(M), slot_in_backpack)
			M.equip_to_slot_or_del(new /obj/item/weapon/complexknife/combatknife, slot_in_backpack)
			...
			W.access = get_all_accesses()
			W.access += get_centcom_access("Special Ops Officer")
			W.assignment = "Burn Team Operative"
			W.registered_name = M.real_name
			W.update_label()
			M.equip_to_slot_or_del(W, slot_wear_id)
