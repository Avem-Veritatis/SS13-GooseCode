...
/datum/global_hud
	...
	var/obj/screen/berserk
	var/obj/screen/brainwashed
	var/list/vimpaired
	var/list/darkMask
...
/datum/global_hud/New()
	...
	berserk = new /obj/screen()
	berserk.screen_loc = "WEST,SOUTH to EAST,NORTH"
	berserk.icon_state = "berserk"
	berserk.blend_mode = BLEND_MULTIPLY
	berserk.layer = 17
	berserk.mouse_opacity = 0

	brainwashed = new /obj/screen()
	brainwashed.screen_loc = "WEST,SOUTH to EAST,NORTH"
	brainwashed.icon_state = "brainwashed"
	brainwashed.blend_mode = BLEND_MULTIPLY
	brainwashed.layer = 17
	brainwashed.mouse_opacity = 0
...
/datum/hud/proc/instantiate()
	...
	if(isork(mymob))
		ui_style = 'icons/mob/screen_ork2.dmi' //Orky hud!
