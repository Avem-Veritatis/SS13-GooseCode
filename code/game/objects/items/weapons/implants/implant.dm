...
/obj/item/weapon/implant/loyalty/get_data()
	var/dat = {"<b>Implant Specifications:</b><BR>
				<b>Name:</b> Imperial Employee Management Implant<BR>
				<b>Life:</b> Ten years.<BR>
				<b>Important Notes:</b> Personnel injected with this device tend to be much more loyal to the Empire of Man.<BR>
				<HR>
				<b>Implant Details:</b><BR>
...
/obj/item/weapon/implant/loyalty/implanted(mob/target)
	if(target.mind in ticker.mode.head_revolutionaries)
		target.visible_message("<span class='warning'>[target] seems to resist the implant!</span>", "<span class='warning'>You feel the imperial tendrils of the God Emperor try to invade your mind!</span>")
		return 0
	if(target.mind in ticker.mode.revolutionaries)
		ticker.mode.remove_revolutionary(target.mind)
	target << "<span class='notice'>You feel a surge of loyalty towards the Emperor!.</span>"
	return 1
