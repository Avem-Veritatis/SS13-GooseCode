/obj/item/blueprints
	...
	desc = "Blueprints of the outpost. There is a \"Classified\" stamp and several coffee stains on it."
...
<small>Property of the Adeptus Mechanicus. For high ranking members of the Cult Mechanicus only. Store in high-secure storage.</small><hr>
"}
...
/obj/item/turretblueprint
	name = "turret blueprints"
	desc = "Blueprints of a spider turret. It appears that you will need to make a set of metal wall girders, then use this blueprint on it."
	icon = 'icons/obj/items.dmi'
	icon_state = "blueprints"
	attack_verb = list("attacked", "bapped", "hit")

/obj/item/turretblueprint/dropped()
