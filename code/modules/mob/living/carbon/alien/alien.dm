...
/mob/living/carbon/alien/proc/handle_environment(var/datum/gas_mixture2/environment)
	...
	if (client)
		for (var/mob/living/C in mob_list)
			if(C.status_flags & XENO_HOST)
				...
				client.images += I
			if(C.mind && C.mind.special_role == "Genestealer Cult Member")
				var/I = image('icons/mob/alien.dmi', loc = C, icon_state = "genestealer")
				client.images += I
	return
