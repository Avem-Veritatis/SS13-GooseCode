...
//flags for tau
#define PASSTAU		16 //You can't just define a bit flag with a value of "1337". It HAS to be the next power of two. A value like 1337 will do very strange things, like make Tau immune to all ranged weapons.
#define PASSULTRA	32 //Next power of two. 16*2 = 32. That is the ONLY value it can be.