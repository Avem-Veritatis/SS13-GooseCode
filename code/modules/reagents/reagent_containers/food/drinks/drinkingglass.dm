	...
	on_reagent_change()
		if (reagents.reagent_list.len > 0)
			switch(reagents.get_master_reagent_id())
				if("arcjuice")
					icon_state = "arcjuiceglass"
					name = "Arc Juice Glass"
					desc = "A glass of Arc Juice"
				if("tranq")
					icon_state = "tranqglass"
					name = "Tranq Glass"
					desc = "A synthetic alchoholic beverage with somewhat unpleasant effects, widely consumed in the Calixis sector."
				if("wildsnake")
					icon_state = "wildsnakeglass"
					name = "Wildsnake Glass"
					desc = "A signature drink of the hive world necromunda."
				if("damassine")
					icon_state = "damassineglass"
					name = "Damassine Glass"
					desc = "An alchoholic beverage with a sweet herbal taste and a hint of almond."
				if("khornedrink")
					icon_state = "khorne"
					name = "glass of Khornate Rum"
					desc = "The blood god's signature drink."
				if("tzeenchdrink")
					icon_state = "tzeench"
					name = "glass of Tzeench's Secret Brew"
					desc = "The changer of ways's signature drink."
				if("slaaneshdrink")
					icon_state = "slaanesh"
					name = "Slaaneshi Shot glass"
					desc = "The lord of pleasure's signature drink."
				if("nurgledrink")
					icon_state = "nurgle"
					name = "glass of nurgle's filth"
					desc = "The plague lord's signature drink."
				if("rotgut")
					icon_state = "rotgut"
					name = "Rotgut glass"
					desc = "This doesn't look fit for human consumption..."
				if("beer")
				...
				if("poisonberryjuice")
					icon_state = "poisonberryjuice" //Or look at the icon.
					name = "Glass of berry juice" //Now you can't tell that it's poisonous from the name... >:D
					desc = "A glass of berry juice... Seems a little off." //Unless you examine it.
				if("carrotjuice")
