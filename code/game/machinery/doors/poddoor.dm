...
/obj/machinery/door/poddoor/baneblade
	name = "Baneblade Blast Door"
	icon_state = "open"
	density = 0
	opacity = 0
	var/health = 30

/obj/machinery/door/poddoor/baneblade/ex_act(exforce)
	var/force = 6-exforce
	if(health > 0)
		health -= force
	else
...
/obj/machinery/door/poddoor/baneblade/outer
	name = "External Blast Door"

/obj/machinery/door/poddoor/baneblade/medium
	name = "Interior Blast Door"

/obj/machinery/door/poddoor/baneblade/inner
	name = "Pilot Blast Door"
