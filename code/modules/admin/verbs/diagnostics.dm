...
/client/proc/air_status(turf/target as turf)
	...
	var/datum/gas_mixture2/GM = target.get_air()
	var/burning = 0
	...
	usr << "\blue @[target.x],[target.y]: O:[GM.oxygen] T:[GM.toxins] N:[GM.nitrogen] C:[GM.carbon_dioxide] w [GM.temperature] Kelvin, [GM.get_pressure()] kPa [(burning)?("\red BURNING"):(null)]"
