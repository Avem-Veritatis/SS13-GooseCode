/obj/item/weapon/tank
	...
	var/datum/gas_mixture2/air_contents = null
...
/obj/item/weapon/tank/New()
	...
	volume *= ONE_ATMOSPHERE
	src.air_contents = new /datum/gas_mixture2()
	src.air_contents.temperature = T20C //Internals aren't at absolute zero!!!
...
/obj/item/weapon/tank/attack_self(mob/user as mob)
	...
	var/message = {"
<b>Tank</b><BR>
<FONT color='blue'><b>Tank Pressure:</b> [air_contents.get_pressure()]</FONT><BR>
<BR>
...
/obj/item/weapon/tank/get_air()
	return air_contents

/obj/item/weapon/tank/assume_air(datum/gas_mixture2/giver)
	air_contents.merge_gas(giver)
...
/obj/item/weapon/tank/proc/remove_air_volume(volume_to_return)
	if(!air_contents)
		return null
	return remove_air(volume_to_return)

/obj/item/weapon/tank/process()
	src.air_contents.burn()
	check_status()
...
/obj/item/weapon/tank/proc/check_status()
	...
	var/pressure = air_contents.get_pressure()-volume
	if(pressure > TANK_FRAGMENT_PRESSURE)
		...
		src.air_contents.burn()
		src.air_contents.burn()
		pressure = air_contents.get_pressure()
