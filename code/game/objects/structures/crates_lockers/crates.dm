...
/obj/structure/closet/crate/dirty
...
/obj/structure/closet/crate/freezer
	...
	get_air()
		var/datum/gas_mixture2/gas = (..())
		if(!gas)	return null
		var/datum/gas_mixture2/newgas = new/datum/gas_mixture2()
		newgas.oxygen = gas.oxygen
		newgas.co2 = gas.co2
		newgas.poison = gas.poison
		newgas.promethium = gas.promethium
		newgas.sleepgas = gas.sleepgas
