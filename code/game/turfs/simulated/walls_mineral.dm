...
/turf/simulated/wall/mineral/plasma/temperature_expose(datum/gas_mixture2/air, exposed_temperature, exposed_volume)//Doesn't fucking work because walls don't interact with air :(
