...
/obj/machinery/door/attackby(obj/item/I as obj, mob/user as mob)
	...
	if(!src.requiresID())
		user = null
	if(src.density && (istype(I, /obj/item/weapon/card/emag)||istype(I, /obj/item/weapon/melee/energy/blade)||istype(I, /obj/item/weapon/USBinterface)))
...
/obj/machinery/door/proc/open()
	...
	src.SetOpacity(0)
	src.layer = 2.7
	if(istype(src, /obj/machinery/door/airlock/mechanicus)) //This one has a significantly longer animation, should take a delay to open.
		spawn(25)
			src.density = 0
			explosion_resistance = 0
			update_icon()
...
///obj/machinery/door/BlockSuperconductivity() //TO HELL WITH SUPERCONDUCTIVITY
