/obj/effect/proc_holder/spell/targeted/ethereal_jaunt
	name = "Personal Teleport"
	desc = "This ability allows you to pass quickly through the warp and move freely for a limited time."
...
/obj/effect/proc_holder/spell/targeted/ethereal_jaunt/cast(list/targets) //magnets, so mostly hardcoded
	for(var/mob/living/target in targets)
		target.notransform = 1 //protects the mob from being transformed (replaced) midjaunt and getting stuck in the warp
		spawn(0)
			var/mobloc = get_turf(target.loc)
			var/obj/effect/dummy/spell_jaunt/holder = new /obj/effect/dummy/spell_jaunt( mobloc )
			var/atom/movable/overlay/animation = new /atom/movable/overlay( mobloc )
			playsound(src.loc, 'sound/effects/teleport1.ogg', 60, 0)
			...
			playsound(src.loc, 'sound/effects/teleport2.ogg', 60, 0)
			sleep(5)
...
/obj/effect/dummy/spell_jaunt/relaymove(var/mob/user, direction)
	...
	for(var/obj/effect/warp/wall/W in range(0, newLoc)) //Warp walls block this as well as holy water.
