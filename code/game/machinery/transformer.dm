/obj/machinery/transformer
	...
	var/cooldown_duration = 100 // 1 minute
	var/cooldown = 0
...
/obj/machinery/transformer/New()
	// On us
	..()
	new /obj/machinery/conveyor/auto/inverted(loc, WEST)
...
/obj/machinery/transformer/conveyor/New()
	...
	if(T)
		...
		if(istype(east, /turf/simulated/floor))
			new /obj/machinery/conveyor/auto/inverted(east, WEST)

		// West
		var/turf/west = locate(T.x - 1, T.y, T.z)
		if(istype(west, /turf/simulated/floor))
			new /obj/machinery/conveyor/auto/inverted(west, WEST)