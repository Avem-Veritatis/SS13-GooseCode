...
datum/design/stunrevolver
	name = "Stun Revolver"
	desc = "A handy imperial stun-gun."
	id = "stunrevolver"
...
datum/design/lasercannon
	name = "Las-Cannon"
	desc = "A standard imperial anti-armor las-weapon."
	id = "lasercannon"
	req_tech = list("combat" = 4, "materials" = 3, "powerstorage" = 3)
	build_type = PROTOLATHE
	materials = list("$metal" = 10000, "$glass" = 10000, "$silver" = 500)
	build_path = /obj/item/weapon/gun/projectile/automatic/lascannon
	locked = 0
...
datum/design/largecrossbow
	...
	desc = "A reverse-engineered Shuriken Pistol."
	id = "largecrossbow"
	...
	build_path = /obj/item/weapon/gun/energy/eldarpistol

datum/design/needler
	name = "Needler Pistol"
	desc = "A needler pistol that fires laser-encased poison darts."
	id = "needler"
	req_tech = list("combat" = 4, "materials" = 5, "engineering" = 3, "biotech" = 4, "syndicate" = 4)
	build_type = PROTOLATHE
	materials = list("$metal" = 4000, "$glass" = 4000)
	build_path = /obj/item/weapon/gun/projectile/automatic/needler
...
datum/design/large_grenade
	name = "Large Grenade"
	desc = "A grenade that affects a larger area, uses larger containers, and can accept three containers."
	id = "large_Grenade"
...
datum/design/heavy_grenade
	name = "Heavy Grenade"
	desc = "A grenade that affects an even larger area and can accept a total of four containers."
	id = "heavy_Grenade"
	req_tech = list("combat" = 4, "materials" = 3)
	build_type = PROTOLATHE
	materials = list("$metal" = 2000)
	reliability = 90
	build_path = /obj/item/weapon/grenade/chem_grenade/large/huge
...
datum/design/mag_bpistol
	name = "Bolter Pistol Magazine"
	desc = "A 10 round magazine for a bolter pistol."
	id = "mag_bpistol"
	req_tech = list("combat" = 2, "materials" = 2)
	build_type = PROTOLATHE
	materials = list("$metal" = 3750)
	build_path = /obj/item/ammo_box/magazine/bpistolmag
...
datum/design/bluespace_crystal
	...
	desc = "A small red crystal with mystical properties."
