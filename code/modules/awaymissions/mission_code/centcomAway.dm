...
/obj/item/weapon/paper/pamphlet/ccaInfo
	...
	used as Imperium's SEGMENTUM COMMAND STATION, organizing and coordinating imperial \
	operations across the vastness of space. <br>\
	Since the completion of the much more efficient CC-A5831 on March 8, 2553, XCC-P5831 no longer \
	acts as the Imperial base of operations but still plays a very important role its affairs; \
