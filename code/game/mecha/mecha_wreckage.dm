...
/obj/structure/mecha_wreckage/mauler
	...
	desc = "The syndicate won't be too happy about this..."

/obj/structure/mecha_wreckage/seraph
	name = "\improper Seraph wreckage"
	icon_state = "seraph-broken"

/obj/structure/mecha_wreckage/baneblade
	name = "\improper Broken Baneblade Piloting System"
	icon_state = "baneblade-broken"
	anchored = 1
...
/obj/structure/mecha_wreckage/killakan
	name = "\improper killakan wreckage"
	icon_state = "killakan-broken"
...
/obj/structure/mecha_wreckage/dreadnought
	name = "\improper Dreadnought wreckage"
	icon = 'icons/migrated/alienqueen.dmi'
	icon_state = "dread2destroyed"
	desc = "Holy crap!"

/obj/structure/mecha_wreckage/wraithlord
	name = "Wraithlord Wreckage"
	icon = 'icons/migrated/alienqueen.dmi'
	icon_state = "wraithlord_dead"
	desc = "Holy crap!"
...
/obj/structure/mecha_wreckage/sentinel
	...
	desc = "Better call the space marines!"

/obj/structure/mecha_wreckage/chimera
	name = "\improper Chimera wreckage"
	icon = 'icons/migrated/alienqueen.dmi'
	icon_state = "chimeradestroyed"
	desc = "Better call the space marines!"

/obj/structure/mecha_wreckage/chimera/inqchimera
	name = "\improper Chimera wreckage"
	icon = 'icons/migrated/alienqueen.dmi'
	icon_state = "chimera_wreckage"
	desc = "Better call the space marines!"

/obj/structure/mecha_wreckage/lemanruss
	name = "\improper Leman Russ Vanquisher Tank"
	icon = 'icons/mecha/lemanruss.dmi'
	icon_state = "vanquisher-wreckage"
	desc = "This tank looks pretty vanquished."
	pixel_x = -24
	pixel_y = -36

/obj/structure/mecha_wreckage/crises
	name = "Tau Wreckage"
	icon = 'icons/migrated/alienqueen.dmi'
	icon_state = "crises_dead"
	desc = "This definately seems to be a crises."