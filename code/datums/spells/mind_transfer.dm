/obj/effect/proc_holder/spell/targeted/mind_transfer
	...
	charge_max = 600
	clothes_req = 0
	invocation = "I SHALL SPLIT YOUR THOUGHTS OPEN!"
...
/obj/effect/proc_holder/spell/targeted/mind_transfer/cast(list/targets,mob/user = usr)
	...
	if(istype(target, /mob/living/silicon/robot/necron) || istype(target, /mob/living/simple_animal/hostile/necron) || istype(target, /mob/living/simple_animal/hostile/scarab) || istype(target, /mob/living/simple_animal/hostile/necronwraith))
		user << "\red The last time people tried placing their minds into these creatures, they ended up losing their souls... Trying this would be a really bad idea."
		return
