...
/obj/structure/closet/syndicate/personal/New()
	...
	sleep(2)
	if (prob (25))
		new /obj/item/weapon/gun/projectile/BPMP(src)
	new /obj/item/weapon/storage/belt/military(src)
	new /obj/item/weapon/gun/projectile/automatic/BPAP(src)
	new /obj/item/ammo_box/magazine/uzim100(src)
	new /obj/item/ammo_box/magazine/uzim100(src)
	new /obj/item/clothing/mask/gas/swat(src)
	new /obj/item/clothing/glasses/night(src)
	new /obj/item/clothing/head/bpimperialhelmet(src)
	new /obj/item/weapon/pinpointer/nukeop(src)
	new /obj/item/weapon/crowbar/red(src)
	if (prob (25))
		new /obj/item/weapon/gun/projectile/automatic/lasgunc(src)
	if (prob (10))
		new /obj/item/weapon/chainsword/chainaxe(src)
	if (prob (10))
		new /obj/item/weapon/chainsword/chainaxe2(src)
	if (prob (5))
		new /obj/item/weapon/gun/projectile/meltagun/bp(src)
	if (prob (50))
		new	/obj/item/clothing/suit/armor/bpimperialarmor(src)
	else
		new /obj/item/clothing/suit/armor/bpimperialarmor2(src)
