...
#define ui_ork_storage_l "CENTER-2:14,SOUTH:5"//ork
#define ui_ork_storage_r "CENTER+1:18,SOUTH:5"//ork
...
#define ui_ork_toxin "EAST-1:28,CENTER+5:25"
#define ui_ork_fire "EAST-1:28,CENTER+4:25"
#define ui_ork_oxygen "EAST-1:28,CENTER+3:25"
...
#define ui_ork_health "EAST-1:28,CENTER-1:15"	//aliens have the health display where humans have the pressure damage indicator.
#define ui_orkwaaghdisplay "EAST-1:28,CENTER-2:15"
