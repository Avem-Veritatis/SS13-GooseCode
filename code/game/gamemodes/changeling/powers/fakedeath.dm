/obj/effect/proc_holder/changeling/fakedeath
	...
	desc = "You fall into a stasis, allowing you to regenerate."
	chemical_cost = 10
	dna_cost = 0
	req_stat = DEAD
...
/obj/effect/proc_holder/changeling/fakedeath/sting_action(var/mob/living/user)
	...
	user << "<span class='notice'>You begin your stasis, preparing yourself to arise once more.</span>"
	...
	spawn(800)
		if(user && user.mind && user.mind.changeling && user.mind.changeling.purchasedpowers)
			user << "<span class='notice'>You are ready to arise once more.</span>"
