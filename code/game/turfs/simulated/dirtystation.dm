...
/obj/effect/decal/cleanable/blood/gibs/old/streak(var/list/directions)
	spawn (0)
...
/turf/simulated/floor/proc/MakeDirty()
	...
	if(istype(src, /turf/simulated/floor/carpet) || istype(src, /turf/simulated/floor/grass) || istype(src, /turf/simulated/floor/beach) || istype(src, /turf/simulated/floor/holofloor) || istype(src, /turf/unsimulated/floor/snow) || istype(src, /turf/simulated/floor/plating/ironsand))
		return
