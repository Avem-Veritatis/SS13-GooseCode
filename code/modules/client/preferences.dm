...
var/global/list/special_roles = list( //keep synced with the defines BE_* in setup.dm //This file doesn't appear to exist...?
//some autodetection here.
	...
	"celebrity" = IS_MODE_COMPILED("celebrity"),		 //10
	"necron" = IS_MODE_COMPILED("necron"),  //11? What is this for...
)
				...
				if(jobban_isbanned(user, "Syndicate"))
					...
					for (var/i in special_roles)
						if(special_roles[i]) //if mode is available on the server
							if(jobban_isbanned(user, i)) //I don't want to change every last tag behind the scenes... This will have to do. Sigh.
								if(i == "traitor")
									dat += "<b>Be heretic:</b> <font color=red><b>\[BANNED]</b></font><br>"
								else if(i == "wizard")
									dat += "<b>Be eldar warlock:</b> <font color=red><b>\[BANNED]</b></font><br>"
								else if(i == "operative")
									dat += "<b>Be member of blood pact:</b> <font color=red><b>\[BANNED]</b></font><br>"
								else if(i == "changeling")
									dat += "<b>Be callidus assassin:</b> <font color=red><b>\[BANNED]</b></font><br>"
								else if(i == "alien")
									dat += "<b>Be xeno:</b> <font color=red><b>\[BANNED]</b></font><br>"
								else
								...
								if(i == "traitor")
									dat += "<b>Be heretic:</b> <a href='?_src_=prefs;preference=be_special;num=[n]'>[src.be_special&(1<<n) ? "Yes" : "No"]</a><br>"
								else if(i == "wizard")
									dat += "<b>Be eldar warlock:</b> <a href='?_src_=prefs;preference=be_special;num=[n]'>[src.be_special&(1<<n) ? "Yes" : "No"]</a><br>"
								else if(i == "operative")
									dat += "<b>Be member of blood pact:</b> <a href='?_src_=prefs;preference=be_special;num=[n]'>[src.be_special&(1<<n) ? "Yes" : "No"]</a><br>"
								else if(i == "changeling")
									dat += "<b>Be callidus assassin:</b> <a href='?_src_=prefs;preference=be_special;num=[n]'>[src.be_special&(1<<n) ? "Yes" : "No"]</a><br>"
								else if(i == "alien")
									dat += "<b>Be xeno:</b> <a href='?_src_=prefs;preference=be_special;num=[n]'>[src.be_special&(1<<n) ? "Yes" : "No"]</a><br>"
								else
