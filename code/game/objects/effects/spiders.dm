...
/obj/effect/spider/temperature_expose(datum/gas_mixture2/air, exposed_temperature, exposed_volume)
...
/obj/effect/spider/spiderling
	...
	var/amount_grown = 0
	var/grow_as = null
	var/obj/machinery/atmospherics/vent/entry_vent
...
/obj/effect/spider/spiderling/process()
		...
		if(get_dist(src, entry_vent) <= 1)
			if(!entry_vent.welded)
				...
				if(!vents.len)
					entry_vent = null
					return
				var/obj/machinery/atmospherics/vent/exit_vent = pick(vents)
				if(prob(50))
	...
	//=================
		...
		//ventcrawl!
		for(var/obj/machinery/atmospherics/vent/v in view(7,src))
			if(!v.welded)
				entry_vent = v
