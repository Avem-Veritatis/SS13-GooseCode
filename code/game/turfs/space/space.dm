...
/turf/space/real/New()
	if(!istype(src, /turf/space/transit))
		icon_state = "[((x + y) ^ ~(x * y) + z) % 25]" //That's actually a pretty damn clever way of handling these... If only somebody did that with TRANSIT. -Drake

/turf/space/real/attack_paw(mob/user as mob)
	return src.attack_hand(user)

/turf/space/real/attackby(obj/item/C as obj, mob/user as mob)
...
/turf/space/real/Entered(atom/movable/A as mob|obj)
...
/turf/space/real/proc/Sandbox_Spacemove(atom/movable/A as mob|obj)
	var/cur_x
	var/cur_y
	var/next_x
	var/next_y
