...
/obj/item/weapon/storage/fancy/sixpack_cola
	icon = 'icons/obj/food.dmi'
	icon_state = "sixpack_colabox6"
	icon_type = "sixpack_cola"
	name = "Space Cola sixpack"
	storage_slots = 6
	can_hold = list(/obj/item/weapon/reagent_containers/food/drinks/soda_cans/cola)

/obj/item/weapon/storage/fancy/sixpack_cola/New()
	..()
	for(var/i=1; i <= storage_slots; i++)
		new /obj/item/weapon/reagent_containers/food/drinks/soda_cans/cola(src)
	return

/obj/item/weapon/storage/fancy/sixpack_rootbeer
	icon = 'icons/obj/food.dmi'
	icon_state = "sixpack_rootbeerbox6"
	icon_type = "sixpack_rootbeer"
	name = "KoalaCo Root Beer sixpack"
	storage_slots = 6
	can_hold = list(/obj/item/weapon/reagent_containers/food/drinks/soda_cans/rootbeer)

/obj/item/weapon/storage/fancy/sixpack_rootbeer/New()
	..()
	for(var/i=1; i <= storage_slots; i++)
		new /obj/item/weapon/reagent_containers/food/drinks/soda_cans/rootbeer(src)
	return
...
/obj/item/weapon/storage/fancy/sixpack_beer/New()
	..()
	for(var/i=1; i <= storage_slots; i++)
