...
/obj/item/weapon/robot_module/medical
	...
	New()
		...
		emag.reagents.add_reagent("plague", 250)
		emag.name = "blight spray"



/obj/item/weapon/robot_module/engineering
	name = "mechanicus servitor module"
...
/obj/item/weapon/robot_module/security
	name = "imperial guard servitor module"
	...
	New()
		...
		emag = new /obj/item/weapon/gun/projectile/BPMP(src)


/obj/item/weapon/robot_module/janitor
	name = "janitorial servitor module"
...
/obj/item/weapon/robot_module/syndicate
	name = "heretek servitor module"

	New()
		..()
		modules += new /obj/item/weapon/chainsword/chainaxe(src)
		modules += new /obj/item/weapon/gun/energy/laser/cyborg/bolter(src)
		modules += new /obj/item/weapon/gun/projectile/AutoCannon/cyborg(src)
		modules += new /obj/item/weapon/melee/clamp/cyborg(src)
