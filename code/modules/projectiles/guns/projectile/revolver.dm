...
/obj/item/weapon/gun/projectile/revolver/russian/laser
	name = "Russian Laser Revolver"
	desc = "A Russian made revolver of the future. Uses laser shells. It has a single slot in its chamber for a laser."
	mag_type = /obj/item/ammo_box/magazine/internal/cylinder/ruslaser
	icon_state = "ruslaser"