...
/datum/game_mode
	...
	var/uplink_welcome = "Warp Uplink Console:"
	var/uplink_uses = 10
...
/datum/game_mode/proc/send_intercept()
	...
	intercepttext += "<B> Imperial Command has recently been contacted by the following in-system assets in your area, everything seems fine:</B>"

	var/list/possible_modes = list()
	possible_modes.Add("revolution", "wizard", "nuke", "traitor", "malf", "changeling", "cult", "celebrity")
...
/datum/game_mode/proc/get_players_for_role(var/role)
	...
	switch(role)
		...
		if(BE_CELEBRITY)	roletext="celebrity"
		if(BE_NECRON)	roletext="necron"
