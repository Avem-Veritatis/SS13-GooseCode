...
/obj/machinery/disposal
	...
	anchored = 1
	density = 1
	var/datum/gas_mixture2/air_contents	// internal reservoir
...
/obj/machinery/disposal/New()
	...
	air_contents = new/datum/gas_mixture2()
...
/obj/machinery/disposal/initialize()
	...
	//var/atom/L = loc
	var/datum/gas_mixture2/env = new
	env.oxygen = ONE_ATMOSPHERE //Why was it copying over this before... It should always just have normal atmosphere in it.
...
/obj/machinery/disposal/interact(mob/user, var/ai=0)
	...
	var/per = Clamp(100* air_contents.get_pressure() / (SEND_PRESSURE), 0, 100)
...
/obj/machinery/disposal/process()
	...
	if(flush && air_contents.get_pressure() >= SEND_PRESSURE )	// flush can happen even without power
		spawn(0)
			flush()
	...
	air_contents.oxygen += 10

	// if full enough, switch to ready mode
	if(air_contents.oxygen >= SEND_PRESSURE)
		mode = 2
		update()
	return
...
/obj/structure/disposalholder
	invisibility = 101
	var/datum/gas_mixture2/gas = null	// gas used to flush, will appear at exit point
