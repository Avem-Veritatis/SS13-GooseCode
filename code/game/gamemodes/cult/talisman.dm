...
//			user.take_organ_damage(5, 0)
	...
	proc/supply(var/key)
		...
		dat += "<HR>"
		dat += "<A href='?src=\ref[src];rune=newtome'>Tzeentch!</A> - Allows you to summon a new arcane tome.<BR>"
		dat += "<A href='?src=\ref[src];rune=teleport'>Nurgle!</A> - Allows you to move to a rune with the same last word.<BR>"
		dat += "<A href='?src=\ref[src];rune=emp'>Khorne!</A> - Allows you to destroy technology in a short range.<BR>"
		dat += "<A href='?src=\ref[src];rune=conceal'>Tzeentch!</A> - Allows you to conceal the runes you placed on the floor.<BR>"
		dat += "<A href='?src=\ref[src];rune=communicate'>Nurgle!</A> - Allows you to coordinate with others of your cult.<BR>"
		dat += "<A href='?src=\ref[src];rune=runestun'>Slaanesh!</A> - Allows you to stun a person by attacking them with the talisman.<BR>"
		dat += "<A href='?src=\ref[src];rune=armor'>Khorne!</A> - Allows you to summon armoured robes and an unholy blade<BR>"
		dat += "<A href='?src=\ref[src];rune=soulstone'>Nurgle!</A> - Summons a soul stone<BR>"
		dat += "<A href='?src=\ref[src];rune=construct'>Nurgle!</A> - Summons a construct shell for use with captured souls. It is too large to carry on your person.<BR>"
