/obj/item/weapon/paper/pamphlet
	name = "pamphlet"
	icon_state = "pamphlet"
	info = "<b>Welcome to the Imperial Gateway project...</b><br>\
			...
			winning dental plan- but that's not all the Imperial Gateway project has to offer.<br>\
			<br>Because we care about you, we feel it is only fair to make sure you know the risks \
			before you commit to joining the Imperial Gateway project. All away destinations have \
			been fully scanned by a Imperial expeditionary team, and are certified to be 100% safe. \
			We've even left a case of space beer along with the basic materials you'll need to expand \
			the Imperium's operational area and start your new life.<br><br>\
			<b>Gateway Operation Basics</b><br>\
			All Imperial approved Gateways operate on the same basic principals. They operate off \
			...
			As a participant in the Imperial Gateway Project, you will be on the frontiers of space. \
