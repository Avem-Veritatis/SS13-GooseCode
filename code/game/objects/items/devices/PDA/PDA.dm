...
/obj/item/device/pda/attack_self(mob/user as mob)
	...
	if (!owner)
		...
		switch (mode)
			...
			if (3)
				...
				if (isnull(T))
					...
					if (get_pressure)
						...
						//var/n2_level = environment.nitrogen/get_pressure
						...
						dat += "Promethium Vapors: [round(plasma_level*100)]%<br>"
			...
			if (5)
				dat += "<h4><img src=pda_chatroom.png> Imperial Relay Chat</h4>"
