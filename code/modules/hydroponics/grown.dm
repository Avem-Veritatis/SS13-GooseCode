...
/obj/item/weapon/reagent_containers/food/snacks/grown/poppy
	...
	name = "poppy"
	desc = "Long-used as a symbol of rest, peace, and death. Contains opium."
	icon_state = "poppy"
...
/obj/item/weapon/reagent_containers/food/snacks/grown/poppy/add_juice()
	if(..())
		...
		reagents.add_reagent("impedrezene", 1 + round((potency / 10), 1)) //Who thought bicaridine should be in poppies? They are narcotics.
		reagents.add_reagent("morphine", (potency/20))
		reagents.add_reagent("phenol", (potency/40))
...
/obj/item/weapon/reagent_containers/food/snacks/grown/ambrosia/vulgaris
	...
	name = "Lho Leaf"
	desc = "This is a plant that can be dried or ground up to produce narcotic inhalents."

/obj/item/weapon/reagent_containers/food/snacks/grown/ambrosia/vulgaris/add_juice()
	..()
	reagents.add_reagent("lho", 5 + round(potency / 5, 1))
	bitesize = reagents.total_volume

/obj/item/weapon/reagent_containers/food/snacks/grown/ambrosia/deus
	seed = /obj/item/seeds/ambrosiadeusseed
	name = "Lho Deus Leaf"
	desc = "Eating this makes you feel immortal! Possibly because it is a powerful painkiller."
	icon_state = "ambrosiadeus"

/obj/item/weapon/reagent_containers/food/snacks/grown/ambrosia/deus/add_juice()
	..()
	reagents.add_reagent("lho", 15 + round(potency / 5, 1))
	reagents.add_reagent("synaptizine", 3 + round(potency / 10, 1))
	reagents.add_reagent("hyperzine", 3 + round(potency / 10, 1))
	reagents.add_reagent("tricordrazine", 3 + round(potency / 10, 1))
	bitesize = reagents.total_volume
...
obj/item/weapon/reagent_containers/food/snacks/grown/killer
	seed = /obj/item/seeds/killer
	name = "red berry"
	desc = "Yum. You should eat this."
	icon_state = "cherry"

obj/item/weapon/reagent_containers/food/snacks/grown/killer/add_juice()
	if(..())
		reagents.add_reagent("strangle", 5+round(potency / 5, 1))
		reagents.add_reagent("cyanide", 5+round(potency / 5, 1))
		reagents.add_reagent("sfreeze", 5+round(potency / 5, 1))
		bitesize = round(reagents.total_volume/2, 1)

/obj/item/weapon/reagent_containers/food/snacks/grown/killer/attackby(var/obj/item/O as obj, var/mob/user as mob)
	. = ..()
	if (istype(O, /obj/item/device/analyzer/plant_analyzer))
		user << "<span class='info'>- Lethal Toxins: <i>[reagents.total_volume] units </i></span>"

obj/item/weapon/reagent_containers/food/snacks/grown/castor
	seed = /obj/item/seeds/castorseed
	name = "castor bean"
	desc = "A delicious, non-toxic capsule full of helpful healing compounds."
	icon_state = "castor"

obj/item/weapon/reagent_containers/food/snacks/grown/castor/add_juice()
	if(..())
		reagents.add_reagent("nutriment", 5+round(potency / 10, 1))
		reagents.add_reagent("ricin", 1+round(potency / 15, 1))
		bitesize = round(reagents.total_volume, 1)

/obj/item/weapon/reagent_containers/food/snacks/grown/castor/attackby(var/obj/item/O as obj, var/mob/user as mob)
	. = ..()
	if (istype(O, /obj/item/device/analyzer/plant_analyzer))
		user << "<span class='info'>- Danger: Contains Ricin </i></span>"

obj/item/weapon/reagent_containers/food/snacks/grown/almond
	seed = /obj/item/seeds/almond
	name = "almond"
	desc = "An edible tree nut with high nutritional value. Contains trace amounts of cyanide."
	icon_state = "almond"

obj/item/weapon/reagent_containers/food/snacks/grown/almond/add_juice()
	if(..())
		reagents.add_reagent("nutriment", 5+round(potency / 10, 1))
		if(prob(potency*5))
			reagents.add_reagent("cyanide", (potency/30)) //Chance of a tiny bit of cyanide. If you increase potency and distill it, I suppose they could be dangerous...
		bitesize = round(reagents.total_volume, 1)

obj/item/weapon/reagent_containers/food/snacks/grown/hyssop
	seed = /obj/item/seeds/hyssop
	name = "hyssop"
	desc = "A bitter herb."
	icon_state = "grassclump"

obj/item/weapon/reagent_containers/food/snacks/grown/hyssop/add_juice()
	if(..())
		reagents.add_reagent("nutriment", 1 + round(potency / 10, 1))
		reagents.add_reagent("teapowder", 1 + round((potency / 10), 1))
		reagents.add_reagent("thujone", (potency/25))
		reagents.add_reagent("phenol", (potency/40))
		bitesize = round(reagents.total_volume, 1)
...
/obj/item/weapon/reagent_containers/food/snacks/grown/mutant
	seed = /obj/item/seeds/mutant
	name = "Mutant Herbs"
	desc = "These aromatic tips of the mutant herb plant can be eaten or distilled for interesting effects."
	icon_state = "tea_aspera_leaves"

/obj/item/weapon/reagent_containers/food/snacks/grown/mutant/add_juice()
	if(..())
		reagents.add_reagent("curare", 5 + round((potency / 8), 2))
		reagents.add_reagent("phenol", (potency/40))
