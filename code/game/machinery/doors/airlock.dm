...
/obj/machinery/door/airlock/imperial
	icon = 'icons/obj/doors/newdoors.dmi'

/obj/machinery/door/airlock/imperialglass
	icon = 'icons/obj/doors/newdoorsglasssec.dmi'
	opacity = 0
	glass = 1
...
/obj/machinery/door/airlock/engineering
	icon = 'icons/obj/doors/mechanicus.dmi'
	doortype = 3

/obj/machinery/door/airlock/mechanicus
	icon = 'icons/obj/doors/mechanicus.dmi'
	doortype = 3
	heat_proof = 1

/obj/machinery/door/airlock/mechanicusglass
	icon = 'icons/obj/doors/mechanicusglass.dmi'
	doortype = 3
	opacity = 0
	glass = 1
	heat_proof = 1
...
/obj/machinery/door/airlock/maintenance
	...
	icon = 'icons/obj/doors/newdoorsmaint.dmi'
	doortype = 5
...
/obj/machinery/door/airlock/glass
	name = "glass airlock"
	icon = 'icons/obj/doors/halldoor.dmi'
	opacity = 0
	doortype = 7
	glass = 1
...
/obj/machinery/door/airlock/plasma/temperature_expose(datum/gas_mixture2/air, exposed_temperature, exposed_volume)
...
/obj/machinery/door/airlock/vault2
	name = "airlock"
	icon = 'icons/obj/doors/vault2.dmi'
	doortype = 34
...
/obj/machinery/door/airlock/attack_alien(mob/user as mob)
	if(istype(user, /mob/living/carbon/alien/humanoid/tyranid/ravener))
		...
		if(!src.locked && !src.welded && R.rending_claws)
			R << "<span class='warning'> The airlock's motors resist your efforts to force it. And zero fucks given.</span>"
			R.visible_message("\red <b>[R] forces the door open with its claws!</b>")
			src.open()
	..()
