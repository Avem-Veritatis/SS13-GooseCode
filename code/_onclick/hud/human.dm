/datum/hud/proc/human_hud(ui_style = 'icons/mob/screen_midnight.dmi')
	...
	mymob.blind.layer = 18 //In light of new updates, I am going to do this using opacity instead of layers. -Drake
	mymob.blind.alpha = 0

	mymob.clouds1 = new /obj/screen()
	mymob.clouds1.icon = 'icons/mob/screen_full.dmi'
	mymob.clouds1.icon_state = "cloud1"
	mymob.clouds1.name = " "
	mymob.clouds1.screen_loc = "CENTER-7,CENTER-7"
	mymob.clouds1.mouse_opacity = 0
	mymob.clouds1.layer = 17.9
	mymob.clouds1.alpha = 0
	mymob.clouds1.blend_mode = BLEND_MULTIPLY

	mymob.clouds2 = new /obj/screen()
	mymob.clouds2.icon = 'icons/mob/screen_full.dmi'
	mymob.clouds2.icon_state = "cloud2"
	mymob.clouds2.name = " "
	mymob.clouds2.screen_loc = "CENTER-7,CENTER-7"
	mymob.clouds2.mouse_opacity = 0
	mymob.clouds2.layer = 17.9
	mymob.clouds2.alpha = 0
	mymob.clouds2.blend_mode = BLEND_MULTIPLY

	mymob.warp = new /obj/screen()
	mymob.warp.icon = 'icons/mob/screen_full.dmi'
	mymob.warp.icon_state = "warp"
	mymob.warp.name = " "
	mymob.warp.screen_loc = "CENTER-7,CENTER-7"
	mymob.warp.mouse_opacity = 0
	mymob.warp.layer = 18.2
	mymob.warp.alpha = 0

	mymob.beamout = new /obj/screen()
	mymob.beamout.icon = 'icons/mob/screen_full.dmi'
	mymob.beamout.icon_state = "beamout"
	mymob.beamout.name = " "
	mymob.beamout.screen_loc = "CENTER-7,CENTER-7"
	mymob.beamout.mouse_opacity = 0
	mymob.beamout.layer = 18.2
	mymob.beamout.alpha = 0
	mymob.beamout.blend_mode = BLEND_MULTIPLY
	...
	mymob.client.screen += list( mymob.throw_icon, mymob.zone_sel, mymob.oxygen, mymob.pressure, mymob.toxin, mymob.bodytemp, mymob.internals, mymob.fire, mymob.healths, mymob.nutrition_icon, mymob.pullin, mymob.blind, mymob.flash, mymob.damageoverlay, mymob.beamout, mymob.warp, mymob.clouds1, mymob.clouds2, lingchemdisplay, lingstingdisplay) //, mymob.hands, mymob.rest, mymob.sleep) //, mymob.mach )
