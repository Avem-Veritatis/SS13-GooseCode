...
/obj/item/clothing/head/eldar
	icon = 'icons/mob/eldar.dmi'
	name = "Warlock Helmet"
	icon_state = "hat"
	desc = "The helm of an Eldar Guardian. Heavily modified and augmented. This thing has seen extensive use."
	item_state = "hat"
