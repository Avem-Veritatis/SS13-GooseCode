...
/obj/machinery/microwave/proc/cook()
	...
	for(var/obj/item/weapon/grenade/G in src)
		recipe = new /datum/recipe/combustion
	for(var/obj/item/weapon/gun/energy/plasma/P in src)
		recipe = new /datum/recipe/combustion
	for(var/obj/item/weapon/plasmisslea/M in src)
		recipe = new /datum/recipe/combustion
	for(var/obj/item/weapon/misslea/KM in src)
		recipe = new /datum/recipe/combustion
	for(var/obj/item/weapon/plastique/E in src)
		recipe = new /datum/recipe/combustion
	var/obj/cooked
	if (!recipe)
		dirty += 1
		...
		if(cooked)
			cooked.loc = src.loc
		if(!istype(cooked, /obj/item/weapon/grenade)) //No cloning grenades... Just no.
