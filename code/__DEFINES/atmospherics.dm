...
#define BREATH_VOLUME						0.5		//liters in a normal breath //Fuck ideal gas equation.
#define BREATH_PERCENTAGE					(BREATH_VOLUME/CELL_VOLUME)					//Amount of air to take a from a tile
#define HUMAN_NEEDED_OXYGEN					ONE_ATMOSPHERE/6 //Humans start to face serious health issues at about 1/5 of an atmosphere, the conditions at the very top of mount whitney. Full asphyxiation then can be tentatively put at 1/6.
#define NORMPIPERATE						30		//pipe-insulation rate divisor
#define HEATPIPERATE						8		//heat-exch pipe insulation
#define FLOWFRAC							0.99	//fraction of gas transfered per process
#define TANK_LEAK_PRESSURE					(1000.*ONE_ATMOSPHERE)	//Tank starts leaking
#define TANK_RUPTURE_PRESSURE				(2000.*ONE_ATMOSPHERE)	//Tank spills all contents into atmosphere
#define TANK_FRAGMENT_PRESSURE				(3000.*ONE_ATMOSPHERE)	//Boom 3x3 base explosion
#define TANK_FRAGMENT_SCALE	    			(1.*ONE_ATMOSPHERE)	//+1 for each SCALE kPa aboe threshold
