...
/mob/living/silicon/robot/proc/pick_module()
	if(module)
		return
	designation = input("Please, select a module!", "Robot", null, null) in list("Standard", "Mechanicus", "Medicus", "Miner", "Janitor","Service", "Imperial Guard")
...
/mob/living/silicon/robot/proc/updatename()
	...
	if(custom_name)
		...
		changed_name = "[(designation ? "[designation] " : "")]Servitor-[num2text(ident)]"
...
//			chargecount = 0
	...
	else if(istype(W, /obj/item/weapon/card/emag)||istype(W, /obj/item/weapon/USBinterface))		// trying to unlock with an emag card
