...
/obj/item/weapon/reagent_containers/food/drinks/bottle/arcjuice
	name = "Arc Juice"
	desc = "A bottle of Arc Juice. I have no idea what this is. Ask Shadow."
	icon_state = "arc"
	New()
		..()
		reagents.add_reagent("arcjuice", 100)
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/holywater
	...
	desc = "A flask of holy water, blessed in the name of the emperor."
	icon_state = "holyflask"
	New()
		..()
		reagents.add_reagent("holywater", 100)

/obj/item/weapon/reagent_containers/food/drinks/bottle/holywater/afterattack(atom/target, mob/user, proximity)
	..()
	if(!proximity) return // not adjacent
	if(isturf(target) && reagents.total_volume > 0)
		user << "\red You pour the [src] onto the floor."
...
/obj/item/weapon/reagent_containers/food/drinks/bottle/amasec
	name = "Amasec"
	desc = "A bottle of Amasec."
	icon_state = "amasecbottle"
	New()
		..()
		reagents.add_reagent("amasec", 95)
		reagents.add_reagent("wine", 5)
